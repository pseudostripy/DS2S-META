    ...
    internal class CasualItemSet : ItemSetBase
    {
        ...
        internal static Dictionary<int, RandoInfo> SetupDropsDictionary()
        {
            Dictionary<int, RandoInfo> d = new()
            {
                ...
                { 0,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 10, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 20, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 30, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 40, EnemyDropInfo(MapArea.Undefined, "possibly 'see individual enemy instance', or 'special-case'", KL()) },
                { 1100200, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1100201, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1100500, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1020000, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1100000, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1106000, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1156000, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1156100, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1156200, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1160000, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1164100, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1166000, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1166100, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1166200, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1171100, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1171200, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1186000, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1230000, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1230001, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1236000, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1256000, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1256100, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1256200, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1256300, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1256400, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 1310200, EnemyDropInfo(MapArea.HeidesTowerOfFlame, "missing", KL()) },
                { 1310300, EnemyDropInfo(MapArea.HeidesTowerOfFlame, "missing, removed Old Knight?", KL()) },
                { 1310500, EnemyDropInfo(MapArea.HeidesTowerOfFlame, "missing", KL()) },
                { 1320500, EnemyDropInfo(MapArea.HeidesTowerOfFlame, "missing", KL()) },
                { 1330000, EnemyDropInfo(MapArea.HeidesTowerOfFlame, "missing", KL()) },
                { 1333000, EnemyDropInfo(MapArea.HeidesTowerOfFlame, "missing", KL()) },
                { 1336000, EnemyDropInfo(MapArea.HeidesTowerOfFlame, "missing", KL()) },
                { 2110000, EnemyDropInfo(MapArea.ShrineOfAmana, "missing", KL()) },
                { 2116000, EnemyDropInfo(MapArea.ShrineOfAmana, "missing", KL()) },
                { 2216000, EnemyDropInfo(MapArea.DrangleicCastle, "missing", KL()) },
                { 2216100, EnemyDropInfo(MapArea.DrangleicCastle, "missing", KL()) },
                { 2216200, EnemyDropInfo(MapArea.DrangleicCastle, "missing", KL()) },
                { 2240001, EnemyNGPlusInfo(MapArea.UndeadCrypt, "Nameless Usurper removed NG+ content?", KL()) },
                { 2246000, EnemyDropInfo(MapArea.UndeadCrypt, "missing", KL()) },
                { 2246100, EnemyDropInfo(MapArea.UndeadCrypt, "missing", KL()) },
                { 2246200, EnemyDropInfo(MapArea.UndeadCrypt, "missing", KL()) },
                { 2246300, EnemyDropInfo(MapArea.UndeadCrypt, "missing", KL()) },
                { 2246400, EnemyDropInfo(MapArea.UndeadCrypt, "missing", KL()) },
                { 2246500, EnemyDropInfo(MapArea.UndeadCrypt, "missing", KL()) },
                { 2246600, EnemyDropInfo(MapArea.UndeadCrypt, "missing", KL()) },
                { 2246700, EnemyDropInfo(MapArea.UndeadCrypt, "missing", KL()) },
                { 2246800, EnemyDropInfo(MapArea.UndeadCrypt, "missing", KL()) },
                { 2246900, EnemyDropInfo(MapArea.UndeadCrypt, "missing", KL()) },
                { 2247000, EnemyDropInfo(MapArea.UndeadCrypt, "missing", KL()) },
                { 2247100, EnemyDropInfo(MapArea.UndeadCrypt, "missing", KL()) },
                { 2247200, EnemyDropInfo(MapArea.UndeadCrypt, "missing", KL()) },
                { 2247300, EnemyDropInfo(MapArea.UndeadCrypt, "missing", KL()) },
                { 2247400, EnemyDropInfo(MapArea.UndeadCrypt, "missing", KL()) },
                { 5000000, EnemyDropInfo(MapArea.ShulvaSanctumCity, "missing", KL()) },
                { 5001000, EnemyDropInfo(MapArea.ShulvaSanctumCity, "missing", KL()) },
                { 5002000, EnemyDropInfo(MapArea.ShulvaSanctumCity, "missing", KL()) },
                { 5003000, EnemyDropInfo(MapArea.ShulvaSanctumCity, "missing", KL()) },
                { 5004000, EnemyDropInfo(MapArea.ShulvaSanctumCity, "missing", KL()) },
                { 5005000, EnemyDropInfo(MapArea.ShulvaSanctumCity, "missing", KL()) },
                { 5006000, EnemyDropInfo(MapArea.ShulvaSanctumCity, "missing", KL()) },
                { 5007000, EnemyDropInfo(MapArea.ShulvaSanctumCity, "missing", KL()) },
                { 5008000, EnemyDropInfo(MapArea.ShulvaSanctumCity, "missing", KL()) },
                { 5009000, EnemyDropInfo(MapArea.ShulvaSanctumCity, "missing", KL()) },
                { 5037300, EnemyDropInfo(MapArea.ShulvaSanctumCity, "missing", KL()) },
                { 5037400, EnemyDropInfo(MapArea.ShulvaSanctumCity, "missing", KL()) },
                { 6000000, EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 10205000, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 10213000, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 10300100, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 10301100, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 10302100, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 10303100, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 10304100, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 10305000, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 10310000, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 10310100, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 10311000, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 10312000, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 10313000, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 11800100, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 11900000, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 12300000, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 12300100, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 12301000, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 12303000, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 12501000, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 12700400, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 12700500, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 12702000, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 13102000, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 13101000, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 13301000, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 13302000, EnemyRegistInfo(MapArea.Undefined, "missing", KL()) },
                { 13502000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 13505000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 13901000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 14600000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 14602000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 15120100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 15121000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 15200100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 15201100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 15300100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 15300900,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 15301100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 15400000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 15500100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 15700000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 15701000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 15702000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 15703000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 20300000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 20510000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 20510100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 20600200,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 20900100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 21000100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 21000300,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 21200000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 21300000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 22000000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 22200100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 22610000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 30100000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 30101000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 30102000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 30102000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 30103000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 30330000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 30400000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 30500000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 30501000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 30710000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 30970000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 30960000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 31201000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 31202000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 31203000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 31204000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 31205000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 31300000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 31301000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 31800000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 31801000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 32100000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 32101000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 32400000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 32500000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 32600000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 32700000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 33002000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 33003000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 33004100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 33102000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 33200000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 33300000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 33400000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 33700100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 33700400,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 33700500,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 33700600,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 33702200,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 33702300,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 50000000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 50100000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 50300000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 50400000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 50610000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 50620000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 50700000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 50800000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 51460000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 60000000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 60101000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 60200000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 60300000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 60310000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 60700000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 61100000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 61911000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 62500000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 62600000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 62700000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 62800000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 65000100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 65100100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 65300100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 65301100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 65302100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 65303100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 65600100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 65901000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 66101000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 66600100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 66604100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 67110100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 68000100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 68100100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 68800000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 68901000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 70150000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 70360000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 72110000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 74201000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 75500000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 76401000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 77001000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 78501000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 81000000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 81000100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 81000200,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 81000400,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 81200100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 81400800,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 82000100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 82000200,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 82100100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 82200200,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 82200000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 82200100,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 82400000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 83400000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 83410000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 83505000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 83600000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 83730000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 84400000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 84500000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 84810000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 84900000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 85100000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 87900000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                { 99900000,  EnemyDropInfo(MapArea.Undefined, "missing", KL()) },
                ...
                { 84400000, EnemyRegistInfo(MapArea.FOFG, "[FOFG] Catarina Knight Phantom above Seed of a Tree of Giants in NG+", KL(KEYID.SOLDIER)) },
                ...
                { 82400000, EnemyRegistInfo(MapArea.AldiasKeep, "[AldiasKeep] Aslatiel of Mirrah [REG:82400000]", KL(KEYID.ALDIASKEEP)) },
                { 77100000, EnemyRegistInfo(MapArea.AldiasKeep, "[AldiasKeep] Royal Sorcerer Navlaan (NPC) [REG:77100000]", KL(KEYID.ALDIASKEEP)) },
                { 85000000, EnemyNGPlusInfo(MapArea.AldiasKeep, "[AldiasKeep] Painting Guardian Phantom in NG+ [REG:85000000]", KL(KEYID.ALDIASKEEP)) },
                ...
                { 85400000, EnemyRegistNGPlusInfo(MapArea.NoMansWharf, "[Wharf] Aurous Knight Phantom on ship in NG+ [REG:82000000]", KL()) },
                ...
                { 84900000, EnemyRegistInvasion(MapArea.DrangleicCastle, "[Drangleic] Nameless Usurper [REG:84900000]", KL(KEYID.DRANGLEIC)) },
