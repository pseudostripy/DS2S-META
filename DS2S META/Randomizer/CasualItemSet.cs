...
namespace DS2S_META.Randomizer
{
    ...
    internal class CasualItemSet : ItemSetBase
    {
        ...
        internal void SetupShopsDictionary()
        {
            ...
            Dold.Add(30700002, ShopInfo(MapArea.ShadedWoods, "[Head of Vengarl] Red Rust Sword", KL(KEYID.HEADVENGARL)));
            Dold.Add(30700003, ShopInfo(MapArea.ShadedWoods, "[Head of Vengarl] Red Rust Scimitar", KL(KEYID.HEADVENGARL)));
            Dold.Add(30700100, ShopInfo(MapArea.ShadedWoods, "[Head of Vengarl] Red Rust Shield", KL(KEYID.HEADVENGARL)));
            ...
            Dold.Add(72110002, ShopInfo(MapArea.DrangleicCastle, "[Chancellor Wellager - Looking Glass Knight] Black Flamestone Dagger", KL(KEYID.MIRRORKNIGHTEVENT)));
            Dold.Add(72110003, ShopInfo(MapArea.DrangleicCastle, "[Chancellor Wellager - Looking Glass Knight] Yellow Quartz Longsword", KL(KEYID.MIRRORKNIGHTEVENT)));
            Dold.Add(72110004, ShopInfo(MapArea.DrangleicCastle, "[Chancellor Wellager - Looking Glass Knight] Bound Hand Axe", KL(KEYID.MIRRORKNIGHTEVENT)));
            Dold.Add(72110005, ShopInfo(MapArea.DrangleicCastle, "[Chancellor Wellager - Looking Glass Knight] Homunculus Mace", KL(KEYID.MIRRORKNIGHTEVENT)));
            Dold.Add(72110006, ShopInfo(MapArea.DrangleicCastle, "[Chancellor Wellager - Looking Glass Knight] Transgressor's Staff", KL(KEYID.MIRRORKNIGHTEVENT)));
            Dold.Add(72110007, ShopInfo(MapArea.DrangleicCastle, "[Chancellor Wellager - NG + 2] Curved Twinblade", KL(KEYID.WELLAGER)));
            Dold.Add(72110008, ShopInfo(MapArea.DrangleicCastle, "[Chancellor Wellager - NG + 2] Crescent Sickle", KL(KEYID.WELLAGER)));
            Dold.Add(72110100, ShopInfo(MapArea.DrangleicCastle, "[Chancellor Wellager - Looking Glass Knight] Black Flamestone Parma", KL(KEYID.MIRRORKNIGHTEVENT)));
            Dold.Add(72110101, ShopInfo(MapArea.DrangleicCastle, "[Chancellor Wellager - Looking Glass Knight] Yellow Quartz Shield", KL(KEYID.MIRRORKNIGHTEVENT)));
            Dold.Add(72110102, ShopInfo(MapArea.DrangleicCastle, "[Chancellor Wellager - Looking Glass Knight] Bound Wooden Shield", KL(KEYID.MIRRORKNIGHTEVENT)));
            Dold.Add(72110103, ShopInfo(MapArea.DrangleicCastle, "[Chancellor Wellager - Looking Glass Knight] Homunculus Wooden Shield", KL(KEYID.MIRRORKNIGHTEVENT)));
            Dold.Add(72110104, ShopInfo(MapArea.DrangleicCastle, "[Chancellor Wellager - Looking Glass Knight] Transgressor's Leather Shield", KL(KEYID.MIRRORKNIGHTEVENT)));
            Dold.Add(72110105, ShopInfo(MapArea.DrangleicCastle, "[Chancellor Wellager - Looking Glass Knight] Longsword", KL(KEYID.MIRRORKNIGHTEVENT)));
            Dold.Add(72110300, ShopInfo(MapArea.DrangleicCastle, "[Chancellor Wellager - NG + 2] Wrath of the Gods", KL(KEYID.WELLAGER)));
            Dold.Add(72110301, ShopInfo(MapArea.DrangleicCastle, "[Chancellor Wellager - NG + 2] Bountiful Sunlight", KL(KEYID.WELLAGER)));
            Dold.Add(72110302, ShopInfo(MapArea.DrangleicCastle, "[Chancellor Wellager - NG + 2] Great Chaos Fireball", KL(KEYID.WELLAGER)));
            Dold.Add(72110303, ShopInfo(MapArea.DrangleicCastle, "[Chancellor Wellager - NG + 2] Spirit Tree Shield", KL(KEYID.WELLAGER)));
            ...
            Dold.Add(75400602, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia] Radiant Lifegem", KL())); // After Sinner
            Dold.Add(75400004, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Grave Warden Agdayne] Darkdrift", KL(KEYID.AGDAYNE)));
            Dold.Add(75400204, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Grave Warden Agdayne] Agdayne's Black Robe", KL(KEYID.AGDAYNE)));
            Dold.Add(75400205, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Grave Warden Agdayne] Agdayne's Cuffs", KL(KEYID.AGDAYNE)));
            Dold.Add(75400206, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Creighton the Wanderer] Creighton's Chainmail", KL(KEYID.CREIGHTON)));
            Dold.Add(75400207, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Creighton the Wanderer] Creighton's Chain Gloves", KL(KEYID.CREIGHTON)));
            Dold.Add(75400208, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Creighton the Wanderer] Creighton's Chain Leggings", KL(KEYID.CREIGHTON)));
            Dold.Add(75400100, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Benhart of Jugo] Benhart's Parma", KL()));
            Dold.Add(75400209, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Benhart of Jugo] Benhart's Knight Helm", KL()));
            Dold.Add(75400210, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Benhart of Jugo] Benhart's Armor", KL()));
            Dold.Add(75400211, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Benhart of Jugo] Benhart's Gauntlets", KL()));
            Dold.Add(75400212, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Benhart of Jugo] Benhart's Boots", KL()));
            Dold.Add(75400213, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Mild Mannered Pate] Pate's Helm", KL()));
            Dold.Add(75400214, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Mild Mannered Pate] Pate's Armor", KL()));
            Dold.Add(75400215, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Mild Mannered Pate] Pate's Gloves", KL()));
            Dold.Add(75400216, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Mild Mannered Pate] Pate's Trousers", KL()));
            Dold.Add(75400101, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Mild Mannered Pate] Pate's Shield", KL()));
            Dold.Add(75400217, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Cale the Cartographer] Cale's Leather Armor", KL()));
            Dold.Add(75400218, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Cale the Cartographer] Cale's Shoes", KL()));
            Dold.Add(75400219, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Lucatiel of Mirrah] Lucatiel's Vest", KL()));
            Dold.Add(75400220, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Lucatiel of Mirrah] Lucatiel's Gloves", KL()));
            Dold.Add(75400221, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Lucatiel of Mirrah] Lucatiel's Trousers", KL()));
            Dold.Add(75400005, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Lucatiel of Mirrah] Mirrah Greatsword", KL()));
            Dold.Add(75400222, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Straid of Olaphis] Black Robes", KL(KEYID.STRAID))); // loosely
            Dold.Add(75400223, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Straid of Olaphis] Black Gloves", KL(KEYID.STRAID)));
            Dold.Add(75400224, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Straid of Olaphis] Black Boots", KL(KEYID.STRAID)));
            Dold.Add(75400225, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Licia of Lindeldt] Saint's Hood", KL()));
            Dold.Add(75400226, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Licia of Lindeldt] Saint's Dress", KL()));
            Dold.Add(75400227, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Licia of Lindeldt] Saint's Long Gloves", KL()));
            Dold.Add(75400228, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Licia of Lindeldt] Saint's Trousers", KL()));
            Dold.Add(75400229, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Felkin the Outcast] Hexer's Hood", KL(KEYID.ROTUNDA)));
            Dold.Add(75400230, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Felkin the Outcast] Hexer's Robes", KL(KEYID.ROTUNDA)));
            Dold.Add(75400231, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Felkin the Outcast] Hexer's Gloves", KL(KEYID.ROTUNDA)));
            Dold.Add(75400232, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Felkin the Outcast] Hexer's Boots", KL(KEYID.ROTUNDA)));
            Dold.Add(75400233, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Royal Sorcerer Navlaan] Chaos Robe", KL(KEYID.ALDIASKEEP)));
            Dold.Add(75400234, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Royal Sorcerer Navlaan] Chaos Gloves", KL(KEYID.ALDIASKEEP)));
            Dold.Add(75400235, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Royal Sorcerer Navlaan] Chaos Boots", KL(KEYID.ALDIASKEEP)));
            Dold.Add(75400236, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Titchy Gren] Nahr Alma Robes", KL(KEYID.ROTUNDA)));
            Dold.Add(75400006, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Titchy Gren] Scythe of Nahr Alma", KL(KEYID.ROTUNDA)));
            Dold.Add(75400237, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Blue Sentinel Targray] Targray's Helm", KL()));
            Dold.Add(75400238, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Blue Sentinel Targray] Targray's Armor", KL()));
            Dold.Add(75400239, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Blue Sentinel Targray] Targray's Manifers", KL()));
            Dold.Add(75400240, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Blue Sentinel Targray] Targray's Leggings", KL()));
            Dold.Add(75400007, ShopInfo(MapArea.FOFG, "[Merchant Hag Melentia - Manscorpion Tark] Black Scorpion Stinger", KL(KEYID.SHADEDWOODS)));
            ...
            Dold.Add(76100211, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - 1000 Souls] Royal Soldier Helm", KL()));
            Dold.Add(76100212, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - 1000 Souls] Royal Soldier Armor", KL()));
            Dold.Add(76100213, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - 1000 Souls] Royal Soldier Gauntlet", KL()));
            Dold.Add(76100214, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - 1000 Souls] Royal Soldier Leggings", KL()));
            Dold.Add(76100215, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - 1000 Souls] Elite Knight Helm", KL()));
            Dold.Add(76100216, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - 1000 Souls] Elite Knight Armor", KL()));
            Dold.Add(76100217, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - 1000 Souls] Elite Knight Gloves", KL()));
            Dold.Add(76100218, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - 1000 Souls] Elite Knight Leggings", KL()));
            ...
            Dold.Add(76100227, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - 15000 Souls] Alva Helm", KL()));
            Dold.Add(76100228, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - 15000 Souls] Alva Armor", KL()));
            Dold.Add(76100229, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - 15000 Souls] Alva Gauntlets", KL()));
            Dold.Add(76100230, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - 15000 Souls] Alva Leggings", KL()));
            Dold.Add(76100235, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Smelter Demon] Smelter Demon Helm", KL(KEYID.IRONKEEP)));
            Dold.Add(76100236, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Smelter Demon] Smelter Demon Armor", KL(KEYID.IRONKEEP)));
            Dold.Add(76100237, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Smelter Demon] Smelter Demon Gauntlets", KL(KEYID.IRONKEEP)));
            Dold.Add(76100238, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Smelter Demon] Smelter Demon Leggings", KL(KEYID.IRONKEEP)));
            Dold.Add(76100239, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Looking Glass Knight] Looking Glass Mask", KL(KEYID.MIRRORKNIGHTEVENT)));
            Dold.Add(76100240, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Looking Glass Knight] Looking Glass Armor", KL(KEYID.MIRRORKNIGHTEVENT)));
            Dold.Add(76100241, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Looking Glass Knight] Looking Glass Gauntlets", KL(KEYID.MIRRORKNIGHTEVENT)));
            Dold.Add(76100242, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Looking Glass Knight] Looking Glass Leggings", KL(KEYID.MIRRORKNIGHTEVENT)));
            Dold.Add(76100243, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Lost Sinner] Penal Mask", KL(KEYID.SINNERSRISE)));
            Dold.Add(76100244, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Lost Sinner] Penal Straightjacket", KL(KEYID.SINNERSRISE)));
            Dold.Add(76100245, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Lost Sinner] Penal Handcuffs", KL(KEYID.SINNERSRISE)));
            Dold.Add(76100246, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Lost Sinner] Penal Skirt", KL(KEYID.SINNERSRISE)));
            Dold.Add(76100247, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Velstadt] Velstadt's Helm", KL(KEYID.UNDEADCRYPT)));
            Dold.Add(76100248, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Velstadt] Velstadt's Armor", KL(KEYID.UNDEADCRYPT)));
            Dold.Add(76100249, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Velstadt] Velstadt's Gauntlets", KL(KEYID.UNDEADCRYPT)));
            Dold.Add(76100250, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Velstadt] Velstadt's Leggings", KL(KEYID.UNDEADCRYPT)));
            Dold.Add(76100251, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Thorne Defenders] Throne Defender Helm", KL(KEYID.THRONEWANT)));
            Dold.Add(76100252, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Thorne Defenders] Throne Defender Armor", KL(KEYID.THRONEWANT)));
            Dold.Add(76100253, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Thorne Defenders] Throne Defender Gauntlets", KL(KEYID.THRONEWANT)));
            Dold.Add(76100254, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Thorne Defenders] Throne Defender Leggings", KL(KEYID.THRONEWANT)));
            Dold.Add(76100255, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Thorne Defenders] Throne Watcher Helm", KL(KEYID.THRONEWANT)));
            Dold.Add(76100256, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Thorne Defenders] Throne Watcher Armor", KL(KEYID.THRONEWANT)));
            Dold.Add(76100257, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Thorne Defenders] Throne Watcher Gauntlets", KL(KEYID.THRONEWANT)));
            Dold.Add(76100258, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Thorne Defenders] Throne Watcher Leggings", KL(KEYID.THRONEWANT)));
            Dold.Add(76100259, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - 15000 Souls, NG + 3] Moon Butterfly Hat", KL()));
            Dold.Add(76100260, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - 15000 Souls, NG + 2] Moon Butterfly Wings", KL()));
            Dold.Add(76100261, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - 15000 Souls, NG + 2] Moon Butterfly Cuffs", KL()));
            Dold.Add(76100262, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - 15000 Souls, NG + 2] Moon Butterfly Skirt", KL()));
            Dold.Add(76100263, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Burnt Ivory King, 50 Loyce Souls] Ivory King Helm", KL(KEYID.DLC3)));
            Dold.Add(76100264, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Burnt Ivory King, 50 Loyce Souls] Ivory King Armor", KL(KEYID.DLC3)));
            Dold.Add(76100265, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Burnt Ivory King, 50 Loyce Souls] Ivory King Gauntlets", KL(KEYID.DLC3)));
            Dold.Add(76100266, ShopInfo(MapArea.Majula, "[Maughlin the Armourer - Burnt Ivory King, 50 Loyce Souls] Ivory King Leggings", KL(KEYID.DLC3)));
            ...
            Dold.Add(76200606, ShopInfo(MapArea.HarvestValley, "[Stone Trader Chloanne] 1 Slab after Velstadt", KL(KEYID.UNDEADCRYPT)));
            Dold.Add(76200607, ShopInfo(MapArea.HarvestValley, "[Stone Trader Chloanne] 3 Twinklings after Velstadt", KL(KEYID.UNDEADCRYPT)));
            Dold.Add(76200608, ShopInfo(MapArea.HarvestValley, "[Stone Trader Chloanne] 3 PDB after Velstadt", KL(KEYID.UNDEADCRYPT)));
            Dold.Add(76200609, ShopInfo(MapArea.HarvestValley, "[Stone Trader Chloanne] 3 Faintstones after Velsadt", KL(KEYID.UNDEADCRYPT)));
            Dold.Add(76200610, ShopInfo(MapArea.HarvestValley, "[Stone Trader Chloanne] 3 Boltstones after Velstadt", KL(KEYID.UNDEADCRYPT)));
            Dold.Add(76200611, ShopInfo(MapArea.HarvestValley, "[Stone Trader Chloanne] 3 Firedrake stones after Velstadt", KL(KEYID.UNDEADCRYPT)));
            Dold.Add(76200612, ShopInfo(MapArea.HarvestValley, "[Stone Trader Chloanne] 3 Darknight stones after Velstadt", KL(KEYID.UNDEADCRYPT)));
            Dold.Add(76200613, ShopInfo(MapArea.HarvestValley, "[Stone Trader Chloanne] 3 Poison stones after Velstadt", KL(KEYID.UNDEADCRYPT)));
            Dold.Add(76200614, ShopInfo(MapArea.HarvestValley, "[Stone Trader Chloanne] 3 Bleed stones after Velstadt", KL(KEYID.UNDEADCRYPT)));
            Dold.Add(76200615, ShopInfo(MapArea.HarvestValley, "[Stone Trader Chloanne] 3 Raw stones after Velstadt", KL(KEYID.UNDEADCRYPT)));
            Dold.Add(76200616, ShopInfo(MapArea.HarvestValley, "[Stone Trader Chloanne] 3 Magic stones after Velstadt", KL(KEYID.UNDEADCRYPT)));
            Dold.Add(76200617, ShopInfo(MapArea.HarvestValley, "[Stone Trader Chloanne] 3 Old Mundane stones after Velstadt", KL(KEYID.UNDEADCRYPT)));
            Dold.Add(76200618, ShopInfo(MapArea.HarvestValley, "[Stone Trader Chloanne] 1 Bonfire Ascetic", KL()));
            Dold.Add(76200600, ShopSustain(MapArea.HarvestValley, "[Stone Trader Chloanne] 10 Titanite shards", KL(KEYID.CHLOANNE)));
            Dold.Add(76200602, ShopSustain(MapArea.HarvestValley, "[Stone Trader Chloanne] 10 Large Shards after OIK", KL(KEYID.IRONKEEP)));
            Dold.Add(76200604, ShopSustain(MapArea.HarvestValley, "[Stone Trader Chloanne] 10 Chunks after Velstadt", KL(KEYID.UNDEADCRYPT)));
            ...
            Dold.Add(76800000, ShopInfo(MapArea.TheLostBastille, "[Straid of Olaphis - 5 Forlorn] Greatsword of the Forlorn", KL(KEYID.STRAID)));
            Dold.Add(76800001, ShopInfo(MapArea.TheLostBastille, "[Straid of Olaphis - 5 Forlorn] Scythe of the Forlorn", KL(KEYID.STRAID)));
            Dold.Add(76800200, ShopInfo(MapArea.TheLostBastille, "[Straid of Olaphis - 1 Forlorn] Hood of the Forlorn", KL(KEYID.STRAID)));
            Dold.Add(76800201, ShopInfo(MapArea.TheLostBastille, "[Straid of Olaphis - 4 Forlorn] Armor of the Forlorn", KL(KEYID.STRAID)));
            Dold.Add(76800202, ShopInfo(MapArea.TheLostBastille, "[Straid of Olaphis - 2 Forlorn] Gauntlets of the Forlorn", KL(KEYID.STRAID)));
            Dold.Add(76800203, ShopInfo(MapArea.TheLostBastille, "[Straid of Olaphis - 3 Forlorn] Leggings of the Forlorn", KL(KEYID.STRAID)));
            ...
            Dold.Add(76800302, ShopInfo(MapArea.TheLostBastille, "[Straid of Olaphis - Undead Crypt] Great Lightning Spear", KL(KEYID.STRAID)));
            Dold.Add(76800303, ShopInfo(MapArea.TheLostBastille, "[Straid of Olaphis] Unveil", KL(KEYID.STRAID)));
            Dold.Add(76800304, ShopInfo(MapArea.TheLostBastille, "[Straid of Olaphis - Undead Crypt] Sunlight Blade", KL(KEYID.STRAID)));
            ...
            Dold.Add(76800402, ShopInfo(MapArea.TheLostBastille, "[Straid of Olaphis] Forlorn related", KL(KEYID.STRAID)));
            ...
            Dold.Add(77200208, ShopInfo(MapArea.IronKeep, "[Magerold of Lanafir - NG + 2] Dragonrider Helm", KL(KEYID.IRONKEEP)));
            Dold.Add(77200209, ShopInfo(MapArea.IronKeep, "[Magerold of Lanafir - NG + 2] Dragonrider Armor", KL(KEYID.IRONKEEP)));
            Dold.Add(77200210, ShopInfo(MapArea.IronKeep, "[Magerold of Lanafir - NG + 2] Dragonrider Gauntlets", KL(KEYID.IRONKEEP)));
            Dold.Add(77200211, ShopInfo(MapArea.IronKeep, "[Magerold of Lanafir - NG + 2] Dragonrider Leggings", KL(KEYID.IRONKEEP)));
            Dold.Add(77200212, ShopInfo(MapArea.IronKeep, "[Magerold of Lanafir - Fume Knight] Raime's Helm", KL(KEYID.FUME)));
            Dold.Add(77200213, ShopInfo(MapArea.IronKeep, "[Magerold of Lanafir - Fume Knight] Raime's Armor", KL(KEYID.FUME)));
            Dold.Add(77200214, ShopInfo(MapArea.IronKeep, "[Magerold of Lanafir - Fume Knight] Raime's Gauntlets", KL(KEYID.FUME)));
            Dold.Add(77200215, ShopInfo(MapArea.IronKeep, "[Magerold of Lanafir - Fume Knight] Raime's Leggings", KL(KEYID.FUME)));
            Dold.Add(77200216, ShopInfo(MapArea.IronKeep, "[Magerold of Lanafir - Sir Alonne] Alonne's Helm", KL(KEYID.ALONNE)));
            Dold.Add(77200217, ShopInfo(MapArea.IronKeep, "[Magerold of Lanafir - Sir Alonne] Alonne's Armor", KL(KEYID.ALONNE)));
            Dold.Add(77200218, ShopInfo(MapArea.IronKeep, "[Magerold of Lanafir - Sir Alonne] Alonne's Gauntlets", KL(KEYID.ALONNE)));
            Dold.Add(77200219, ShopInfo(MapArea.IronKeep, "[Magerold of Lanafir - Sir Alonne] Alonne's Leggings", KL(KEYID.ALONNE)));
            ...
            Dold.Add(77600603, ShopInfo(MapArea.Tseldora, "[Weaponsmith Ornifex] Green Blossom", KL(KEYID.ORNIFEX)));
            Dold.Add(77600604, ShopInfo(MapArea.Tseldora, "[Weaponsmith Ornifex] Amber Herb", KL(KEYID.ORNIFEX)));
            Dold.Add(77600605, ShopInfo(MapArea.Tseldora, "[Weaponsmith Ornifex - Nashandra] Green Blossom", KL(KEYID.ORNIFEX)));
            Dold.Add(77600606, ShopInfo(MapArea.Tseldora, "[Weaponsmith Ornifex - Nashandra] Twilight Herb", KL(KEYID.ORNIFEX)));
            ...
            Dold.Add(78300200, ShopInfo(MapArea.UndeadPurgatory, "[Titchy Gren - Skeleton Lords] Bone Crown", KL(KEYID.TITCHY)));
            Dold.Add(78300201, ShopInfo(MapArea.UndeadPurgatory, "[Titchy Gren - Skeleton Lords] Bone King Robe", KL(KEYID.TITCHY)));
            Dold.Add(78300202, ShopInfo(MapArea.UndeadPurgatory, "[Titchy Gren - Skeleton Lords] Bone King Cuffs", KL(KEYID.TITCHY)));
            Dold.Add(78300203, ShopInfo(MapArea.UndeadPurgatory, "[Titchy Gren - Skeleton Lords] Bone King Skirt", KL(KEYID.TITCHY)));
            Dold.Add(78300204, ShopInfo(MapArea.UndeadPurgatory, "[Titchy Gren - Shrine of Winter] Executioner Helm", KL(KEYID.EXECUTIONERSET)));
            Dold.Add(78300205, ShopInfo(MapArea.UndeadPurgatory, "[Titchy Gren - Shrine of Winter] Executioner Armor", KL(KEYID.EXECUTIONERSET)));
            Dold.Add(78300206, ShopInfo(MapArea.UndeadPurgatory, "[Titchy Gren - Shrine of Winter] Executioner Gauntlets", KL(KEYID.EXECUTIONERSET)));
            Dold.Add(78300207, ShopInfo(MapArea.UndeadPurgatory, "[Titchy Gren - Shrine of Winter] Executioner Leggings", KL(KEYID.EXECUTIONERSET)));
