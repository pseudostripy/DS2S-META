...
namespace DS2S_META.Randomizer
{
    ...
    internal class CasualItemSet : ItemSetBase
    {
        ...
        internal static Dictionary<string, string> ShopMerchantNames = new()
        {
            ...
            ["Laddersmith Gilligan"] = "Gilligan",
            ["Chancellor Wellager"] = "Wellager",
            ["Darkdiver Grandahl"] = "Darkdiver Grandahl",
            ["Lonesome Gavlan"] = "Gavlan",
            ["Merchant Hag Melentia"] = "Melentia",
            ["The Rat King"] = "Rat King",
            ["Maughlin the Armourer"] = "Maughlin",
            ["Stone Trader Chloanne"] = "Chloanne",
            ["Rosabeth of Melfia"] = "Rosabeth",
            ["Steady Hand McDuff"] = "McDuff",
            ["Blacksmith Lenigrast"] = "Blacksmith",
            ["Carhillion of the Fold"] = "Carhillion",
            ["Straid of Olaphis"] = "Straid",
            ["Licia of Lindeldt"] = "Licia",
            ["Felkin the Outcast"] = "Felkin",
            ["Royal Sorcerer Navlaan"] = "Navlan",
            ["Magerold of Lanafir"] = "Magerold",
            ["Weaponsmith Ornifex"] = "Ornifex",
            ["Cat"] = "Shalquoir",
            ["Titchy Gren"] = "Titchy Gren",
        ...
        internal static Dictionary<int, RandoInfo> SetupShopsDictionary()
        {
            Dictionary<int, RandoInfo> d = new()
            {
                ...
                { 75400601, ShopRemoveInfo(MapArea.FOFG, "[Merchant Hag Melentia] Lifegems after LG", KL()) },
                ...
                { 76430606, ShopInfo(MapArea.TheLostBastille, "[Steady Hand McDuff] light powder of repair", KL(KEYID.MCDUFF)) },
                { 76430000, ShopSustain(MapArea.TheLostBastille, "[Steady Hand McDuff] Royal Kite Shield", KL(KEYID.MCDUFF)) },
                { 76430001, ShopSustain(MapArea.TheLostBastille, "[Steady Hand McDuff] Busted Sword", KL(KEYID.MCDUFF)) },
                { 76430002, ShopSustain(MapArea.TheLostBastille, "[Steady Hand McDuff] Great Axe", KL(KEYID.MCDUFF)) },
                { 76430003, ShopSustain(MapArea.TheLostBastille, "[Steady Hand McDuff] Winged Spear", KL(KEYID.MCDUFF)) },
                { 76430004, ShopSustain(MapArea.TheLostBastille, "[Steady Hand McDuff] size", KL(KEYID.MCDUFF)) },
                { 76430005, ShopSustain(MapArea.TheLostBastille, "[Steady Hand McDuff] Longbow", KL(KEYID.MCDUFF)) },
                { 76430006, ShopSustain(MapArea.TheLostBastille, "[Steady Hand McDuff] Light Crossbow", KL(KEYID.MCDUFF)) },
                { 76430100, ShopSustain(MapArea.TheLostBastille, "[Steady Hand McDuff] Cavalry Kite Shield", KL(KEYID.MCDUFF)) },
                { 76430007, ShopRemoveInfo(MapArea.TheLostBastille, "[Steady Hand McDuff] sword", KL(KEYID.MCDUFF)) },
                { 76430008, ShopRemoveInfo(MapArea.TheLostBastille, "[Steady Hand McDuff] Busted Sword", KL(KEYID.MCDUFF)) },
                { 76430009, ShopRemoveInfo(MapArea.TheLostBastille, "[Steady Hand McDuff] Great Axe", KL(KEYID.MCDUFF)) },
                { 76430010, ShopRemoveInfo(MapArea.TheLostBastille, "[Steady Hand McDuff] Windspear", KL(KEYID.MCDUFF)) },
                { 76430011, ShopRemoveInfo(MapArea.TheLostBastille, "[Steady Hand McDuff] size", KL(KEYID.MCDUFF)) },
                { 76430012, ShopRemoveInfo(MapArea.TheLostBastille, "[Steady Hand McDuff] Longbow", KL(KEYID.MCDUFF)) },
                { 76430013, ShopRemoveInfo(MapArea.TheLostBastille, "[Steady Hand McDuff] Light Crossbow", KL(KEYID.MCDUFF)) },
                { 76430102, ShopRemoveInfo(MapArea.TheLostBastille, "[Steady Hand McDuff] Cavalry Kite Shield", KL(KEYID.MCDUFF)) },
        ...
        internal static Dictionary<int, RandoInfo> SetupDropsDictionary()
        {
            Dictionary<int, RandoInfo> d = new()
            {
                ...
                { 6000000, UnreachableDropInfo(MapArea.Undefined, "missing [special empty?]", KL()) },
                ...
                { 13200600, EnemyRegistInfo(MapArea.FOFG, "[FOFG] Skeleton in dark area towards Soldier's Rest bonfire [REG:13200000]", KL(KEYID.SOLDIER)) },
                { 13201500, EnemyRegistInfo(MapArea.FOFG, "[FOFG] Skeleton in dark area towards Soldier's Rest bonfire [REG:13201000]", KL(KEYID.SOLDIER)) },
                { 13203000, EnemyRegistInfo(MapArea.FOFG, "[FOFG] Skeleton in dark area towards Soldier's Rest bonfire [REG:13203000]", KL(KEYID.SOLDIER)) },
