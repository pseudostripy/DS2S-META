...
namespace DS2S_META.Utils.Offsets
{
    internal class DS2VOffsets : DS2HookOffsets
    {
        ...
        {
            // BaseA
            BaseAAob = "8B F1 8B 0D ? ? ? ? 8B 01 8B 50 28 FF D2 84 C0 74 0C";
            ...
            PlayerCtrl = new(HP: 0xFC, HPMin: 0x100, HPMax: 0x104, HPCap: 0x108, 
                             SP: 0x140, SPMax: 0x148, SpeedModifier: 0x208, CurrPoise:0x1ac, SPMin: 0x144); // Need to find the value for vanilla, testing for scholar for now
