    ...
    public static class DS2REData
    {
        ...
        public static readonly List<PointerDefn> PointerDefns = new()
        {
            ...
            new("GiveSoulsFuncAoB", new List<LocatorDefn>()
            {
                ...
                new(V111OR112, new AbsoluteAOBCL("55 8B EC 8B 01 83 EC 08 85 C0 74 20 8B 80 94 00 00 00")),
                new(V102, new AbsoluteAOBCL("55 8b ec 8b 81 e8 00 00 00 8b 55 08 83 ec 08 56"))
            }),
            ...
            new("DisablePoisonBuildupAoB", new List<LocatorDefn> ()
            {
                new(S103, new AbsoluteAOBCL("89 84 8B C4 01 00 00")),
            }),
            new("DisableSkirtPoisonAoB", new List<LocatorDefn> ()
            {
                new(S103, new AbsoluteAOBCL("FF 50 08 C7 47 50 00")),
            }),
        ...
        new ("BonfireLevelsGroup", "BonfireLevelsPtr",
                ...
                new DetachedLeaf("SanctumWalk", (ANYSOTFS, 0x572), (V111OR112, 0x3a2)),
                new DetachedLeaf("TowerOfPrayerShulva", (ANYSOTFS, 0x602), (V111OR112, 0x402)),
                new DetachedLeaf("PriestessChamber", (ANYSOTFS, 0x58a), (V111OR112, 0x3b2)),
                new DetachedLeaf("HiddenSanctumChamber", (ANYSOTFS, 0x5ba), (V111OR112, 0x3d2)),
                new DetachedLeaf("LairOfTheImperfect", (ANYSOTFS, 0x5d2), (V111OR112, 0x3e2)),
                new DetachedLeaf("SanctumInterior", (ANYSOTFS, 0x5ea), (V111OR112, 0x3f2)),
                new DetachedLeaf("SanctumNadir", (ANYSOTFS, 0x5a2), (V111OR112, 0x3c2)),
                new DetachedLeaf("ThroneFloor", (ANYSOTFS, 0x61a), (V111OR112, 0x412)),
                new DetachedLeaf("UpperFloor", (ANYSOTFS, 0x64a), (V111OR112, 0x432)),
                new DetachedLeaf("Foyer", (ANYSOTFS, 0x632), (V111OR112, 0x422)),
                new DetachedLeaf("LowermostFloor", (ANYSOTFS, 0x67a), (V111OR112, 0x452)),
                new DetachedLeaf("TheSmelterThrone", (ANYSOTFS, 0x692), (V111OR112, 0x462)),
                new DetachedLeaf("IronHallwayEntrance", (ANYSOTFS, 0x662), (V111OR112, 0x442)),
                new DetachedLeaf("OuterWall", (ANYSOTFS, 0x6aa), (V111OR112, 0x472)),
                new DetachedLeaf("AbandonedDwelling", (ANYSOTFS, 0x6c2), (V111OR112, 0x482)),
                new DetachedLeaf("InnerWall", (ANYSOTFS, 0x722), (V111OR112, 0x4c2)),
                new DetachedLeaf("LowerGarrison", (ANYSOTFS, 0x6da), (V111OR112, 0x492)),
                new DetachedLeaf("ExpulsionChamber", (ANYSOTFS, 0x70a), (V111OR112, 0x4b2)),
                new DetachedLeaf("GrandCathedral", (ANYSOTFS, 0x6f2), (V111OR112, 0x4a2))),
